...
const Terms = () => {
  ...
  return (
    <div className={classes.padding}>
      <h1>利用規約</h1>
      <p>
        この利用規約（以下，「本規約」といいます。）は，Dabyss（以下，「当団体」といいます。）が提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。本サービスをご利用される場合には、利用者の皆さまは本規約に同意したものとみなされます。
      </p>
      <h3>第1条（適用）</h3>
      <p>
      ...
      <h3>第2条（利用登録）</h3>
      <p>
        1.ユーザー登録を希望する利用者(以下、「申請者」といいます。)は、本規約に同意し、当団体所定の登録手続きを行っていただきます。
        <br></br>
